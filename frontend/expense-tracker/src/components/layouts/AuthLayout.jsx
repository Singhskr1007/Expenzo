...
const AuthLayout = ({ children }) => {
    return (
        <div className='flex'>
            ...
            <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover 
            bg-no-repeat bg-center overflow-hidden p-8 relative'>
                ...
                <img src={CARD_2} alt="PERSONAL-EXPENSE-TRACK"
...
const StatsInfoCard = ({ icon, label, value}) => {
    return <div className='flex gap-6 bg-white p-4 rounded-xl 
        shadow-md shadow-purple-400/10 border border-gray-200/50 z-10'>
